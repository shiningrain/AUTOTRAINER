...
import numpy as np
import keras
from keras.layers import Dense,SimpleRNN,Dropout,BatchNormalization,LSTM,Embedding,Input
...
x=LSTM(128, activation='sigmoid',kernel_initializer=init, recurrent_initializer='orthogonal', bias_initializer='zeros',dropout=0.2, recurrent_dropout=0.2,return_sequences=True)(x)
...
model.add(LSTM(128, activation='sigmoid',kernel_initializer=init, recurrent_initializer='orthogonal', bias_initializer='zeros',dropout=0.2, recurrent_dropout=0.2,return_sequences=True))
#model.add(BatchNormalization())'''
x=LSTM(128, activation='sigmoid',kernel_initializer=init, recurrent_initializer='orthogonal', bias_initializer='zeros',dropout=0.2, recurrent_dropout=0.2)(x)
#model.add(BatchNormalization())
x=Dropout(0.25)(x)
...
'''
print(model.summary())
model.save('/data/zxy/DL_tools/Training_Automatic_Repaire_Tool/DL_tools/models/seed_model/lstm.h5')
