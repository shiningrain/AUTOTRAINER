...
stringx='case20_LSTM(1rnn_tanh_batch128_adam0.1lr)_IMDB'
epoch=50
labels=10
...
epoch=20
batch_size=256
log_dir='../../log/case20_LSTM/'
if not os.path.exists(log_dir):
    os.makedirs(log_dir)
log_path=log_dir+'case20_LSTM.csv'
fig_name=log_dir+'case20_LSTM.pdf'
callbacks=[]
model_path='/data/zxy/DL_tools/DL_tools/models/TrainingUnstable/case20_LSTM.h5'
