...
data_num = 4000
epochs=200
data = pd.read_csv('/data/zxy/DL_tools/Training_Automatic_Repaire_Tool/DL_tools/code/L-code/gradient_vanish/case-18-gradient_vanish/training.csv',nrows=data_num)
